...
extern uint8_t PIOS_RFM22B_LinkQuality(uint32_t rfm22b_id, uint8_t *good_packets, uint8_t *corrected_packets, uint8_t *error_packets, uint8_t *dropped_packets);
