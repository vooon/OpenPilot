 ...
 * @brief PIOS COM interface for RFM22B Radio
 * @{
 *
...
//! Initialize a PIOS_COM interface to the RFM22b driver
extern int32_t PIOS_RFM22B_COM_Init(uint32_t * rfm22b_com_id, uint32_t rfm22b_id);
