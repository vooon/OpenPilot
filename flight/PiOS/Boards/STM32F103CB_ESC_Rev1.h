...
#define PIOS_LED_LED3_GPIO_PIN			GPIO_Pin_14
...
#define PIOS_ADC_PIN1_GPIO_PIN			GPIO_Pin_6		
#define PIOS_ADC_PIN1_GPIO_CHANNEL		ADC_Channel_6
...
#define PIOS_ADC_PIN3_GPIO_PIN			GPIO_Pin_4
...
/* Tconv = 71.5 + 12.5 = 84 cycles = 18�s */
