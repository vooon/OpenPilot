 ...
 * @{
 * @brief Defines board specific static initializers for hardware for the discoveyf4 board.
 *****************************************************************************/
/* 
...
void PIOS_Board_Init(void) {
...
#if defined(PIOS_MPU6000_SPI)
	/* Set up the SPI interface to the gyro/acelerometer */
	if (PIOS_SPI_Init(&pios_spi_gyro_id, &pios_spi_gyro_cfg)) {
		PIOS_DEBUG_Assert(0);
	}
#endif	/* PIOS_MPU6000_SPI */
	...
	HwSettingsD4_MainPortGet(&hwsettings_mainport);
	switch (hwsettings_mainport) {
		case HWSETTINGS_D4_MAINPORT_DISABLED:
			break;
		case HWSETTINGS_D4_MAINPORT_TELEMETRY:
...
#endif
                        break;
		case HWSETTINGS_D4_MAINPORT_DSM2:
		case HWSETTINGS_D4_MAINPORT_DSMX10BIT:
		case HWSETTINGS_D4_MAINPORT_DSMX11BIT:
			{
	...
	HwSettingsD4_FlexiPortGet(&hwsettings_flexiport);
	switch (hwsettings_flexiport) {
		case HWSETTINGS_D4_FLEXIPORT_DISABLED:
			break;
                case HWSETTINGS_D4_FLEXIPORT_TELEMETRY:
			...
			break;
		case HWSETTINGS_D4_FLEXIPORT_I2C:
			...
			break;
		case HWSETTINGS_D4_FLEXIPORT_GPS:
			PIOS_Board_configure_com(&pios_usart_flexi_cfg, PIOS_COM_GPS_RX_BUF_LEN, -1, &pios_usart_com_driver, &pios_com_gps_id);
			break;
		case HWSETTINGS_D4_FLEXIPORT_DSM2:
		case HWSETTINGS_D4_FLEXIPORT_DSMX10BIT:
		case HWSETTINGS_D4_FLEXIPORT_DSMX11BIT:
			{
				enum pios_dsm_proto proto;
				switch (hwsettings_flexiport) {
				case HWSETTINGS_D4_FLEXIPORT_DSM2:
			...
			break;
		case HWSETTINGS_D4_FLEXIPORT_DEBUGCONSOLE:
#if defined(PIOS_INCLUDE_DEBUG_CONSOLE)
			{
				PIOS_Board_configure_com(&pios_usart_main_cfg, 0, PIOS_COM_DEBUGCONSOLE_TX_BUF_LEN, &pios_usart_com_driver, &pios_com_debug_id);
			}
#endif	/* PIOS_INCLUDE_DEBUG_CONSOLE */
			break;
		case HWSETTINGS_D4_FLEXIPORT_COMBRIDGE:
	...
	HwSettingsD4_RcvrPortGet(&hwsettings_rcvrport);
	//   
	switch (hwsettings_rcvrport){
		case HWSETTINGS_D4_RCVRPORT_DISABLED:
			break;
		case HWSETTINGS_D4_RCVRPORT_PWM:
#if defined(PIOS_INCLUDE_PWM)
			/* Set up the receiver port.  Later this should be optional */
			PIOS_Board_configure_pwm(&pios_pwm_cfg);
#endif	/* PIOS_INCLUDE_PWM */
			break;
		case HWSETTINGS_D4_RCVRPORT_PPM:
		case HWSETTINGS_D4_RCVRPORT_PPMOUTPUTS:
		case HWSETTINGS_D4_RCVRPORT_PPMPWM:
#if defined(PIOS_INCLUDE_PPM)
			if(hwsettings_rcvrport == HWSETTINGS_D4_RCVRPORT_PPMOUTPUTS)
			{
			...
			if(hwsettings_rcvrport == HWSETTINGS_D4_RCVRPORT_PPMPWM)
			{
		...
		case HWSETTINGS_D4_RCVRPORT_OUTPUTS:
