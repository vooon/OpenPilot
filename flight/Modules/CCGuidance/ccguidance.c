...
static void ccguidanceTask(UAVObjEvent * ev)
{
	...
	static float positionDesiredLat	= 0.0f;
	static float positionDesiredLon	= 0.0f;
	static float positionDesiredAlt	= 0.0f;
	static float diffHeadingYaw     = 0.0f;
	static float DistanceToBaseOld  = 0.0f;
	static float SpeedToRTB         = 0.0f;
	...
	static uint32_t thisTimesPeriodCorrectBiasYaw = 0;
	static uint32_t TimeEnableFailSafe  = 0;
	static uint32_t dT                  = 0;
	static uint8_t  TacksNumsRemain     = 0;

	static bool firstRunSetCourse               = TRUE;
	static bool StateSaveCurrentPositionToRTB   = FALSE;
	static bool fixedHeading                    = TRUE;
	static bool TacksAngleRight                 = FALSE;
	static bool firstMeanDiffHeadingYaw         = TRUE;
