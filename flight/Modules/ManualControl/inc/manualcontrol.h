...
#define PARSE_FLIGHT_MODE(x) ( \
	...
	(x == FLIGHTSTATUS_FLIGHTMODE_POSITIONHOLD2) ? FLIGHTMODE_GUIDANCE : \
	(x == FLIGHTSTATUS_FLIGHTMODE_RETURNTOBASE) ? FLIGHTMODE_GUIDANCE : \
	(x == FLIGHTSTATUS_FLIGHTMODE_FLIGHTTOTARGET) ? FLIGHTMODE_GUIDANCE : FLIGHTMODE_UNDEFINED \
	)
...
( (int)MANUALCONTROLSETTINGS_FLIGHTMODEPOSITION_POSITIONHOLD2 == (int) FLIGHTSTATUS_FLIGHTMODE_POSITIONHOLD2) && \
( (int)MANUALCONTROLSETTINGS_FLIGHTMODEPOSITION_RETURNTOBASE == (int) FLIGHTSTATUS_FLIGHTMODE_RETURNTOBASE) && \
( (int)MANUALCONTROLSETTINGS_FLIGHTMODEPOSITION_FLIGHTTOTARGET == (int) FLIGHTSTATUS_FLIGHTMODE_FLIGHTTOTARGET) \
)
