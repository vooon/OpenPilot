...
((int)MANUALCONTROLSETTINGS_STABILIZATION1SETTINGS_ATTITUDEDIRECT  == (int)STABILIZATIONDESIRED_STABILIZATIONMODE_ATTITUDEDIRECT)      \
)
...
((int)MANUALCONTROLSETTINGS_STABILIZATION2SETTINGS_ATTITUDEDIRECT  == (int)STABILIZATIONDESIRED_STABILIZATIONMODE_ATTITUDEDIRECT)     \
)
...
((int)MANUALCONTROLSETTINGS_STABILIZATION3SETTINGS_ATTITUDEDIRECT  == (int)STABILIZATIONDESIRED_STABILIZATIONMODE_ATTITUDEDIRECT)     \
)
