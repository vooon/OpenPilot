...
#define ARMING_CHANNEL_TOGGLE   3
...
( ((int)MANUALCONTROLSETTINGS_ARMING_TOGGLE_STAYARMEDONTXLOSS           -(int)MANUALCONTROLSETTINGS_ARMING_ROLLLEFT)/2 == ARMING_CHANNEL_TOGGLE)	&& \
( ((int)MANUALCONTROLSETTINGS_ARMING_TOGGLE_DISARMONTXLOSS           -(int)MANUALCONTROLSETTINGS_ARMING_ROLLLEFT)/2== ARMING_CHANNEL_TOGGLE)	\
)
