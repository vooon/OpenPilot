...
#define ARMING_CHANNEL_FLAPERONS 3
...
( ((int)MANUALCONTROLSETTINGS_ARMING_FLAPERONSUP        -(int)MANUALCONTROLSETTINGS_ARMING_ROLLLEFT)/2 	== ARMING_CHANNEL_FLAPERONS) 	&& \
( ((int)MANUALCONTROLSETTINGS_ARMING_FLAPERONSDOWN      -(int)MANUALCONTROLSETTINGS_ARMING_ROLLLEFT)/2 	== ARMING_CHANNEL_FLAPERONS)			\
)
...
( ((int)MANUALCONTROLSETTINGS_ARMING_FLAPERONSUP        -(int)MANUALCONTROLSETTINGS_ARMING_ROLLLEFT)%2 	== 0)	&& \
( ((int)MANUALCONTROLSETTINGS_ARMING_FLAPERONSDOWN      -(int)MANUALCONTROLSETTINGS_ARMING_ROLLLEFT)%2 	!= 0)	\
)
