...
typedef enum {FLIGHTMODE_UNDEFINED = 0, FLIGHTMODE_MANUAL = 1, FLIGHTMODE_STABILIZED = 2, FLIGHTMODE_GUIDANCE = 3, FLIGHTMODE_TAKEOFF = 4} flightmode_path;
...
#define PARSE_FLIGHT_MODE(x) ( \
	...
	(x == MANUALCONTROLCOMMAND_FLIGHTMODE_POSITIONHOLD) ? FLIGHTMODE_GUIDANCE : \
	(x == MANUALCONTROLCOMMAND_FLIGHTMODE_TAKEOFF) ? FLIGHTMODE_TAKEOFF : FLIGHTMODE_UNDEFINED \
	)
