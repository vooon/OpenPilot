...
static void updateStabilizationDesired(ManualControlCommandData * cmd, ManualControlSettingsData * settings)
{
	...
	stabilization.Roll = (stab_settings[0] == STABILIZATIONDESIRED_STABILIZATIONMODE_NONE) ? cmd->Roll :
	     ...
	     (stab_settings[0] == STABILIZATIONDESIRED_STABILIZATIONMODE_FREQSWEEP) ? cmd->Roll * stabSettings.ManualRate[STABILIZATIONSETTINGS_MANUALRATE_ROLL] :
	...
	stabilization.Pitch = (stab_settings[1] == STABILIZATIONDESIRED_STABILIZATIONMODE_NONE) ? cmd->Pitch :
	     ...
	     (stab_settings[1] == STABILIZATIONDESIRED_STABILIZATIONMODE_FREQSWEEP) ? cmd->Pitch * stabSettings.ManualRate[STABILIZATIONSETTINGS_MANUALRATE_PITCH] :
	     0; // this is an invalid mode
	...
	stabilization.Yaw = (stab_settings[2] == STABILIZATIONDESIRED_STABILIZATIONMODE_NONE) ? cmd->Yaw :
	     ...
	     (stab_settings[2] == STABILIZATIONDESIRED_STABILIZATIONMODE_FREQSWEEP) ? cmd->Yaw * stabSettings.ManualRate[STABILIZATIONSETTINGS_MANUALRATE_YAW] :
	     0; // this is an invalid mode
