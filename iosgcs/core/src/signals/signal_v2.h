...
template <class Param1, class Param2>
class CL_SignalQueue_v2_Impl : public CL_SignalQueue_Impl
{
public:
	CL_SignalQueue_v2_Impl(CL_Signal_v2<Param1, Param2>* signal, Param1 p1, Param2 p2) : m_signal(signal), m_p1(p1), m_p2(p2) { }
	
	CL_Signal_v2<Param1, Param2>* m_signal;
	Param1 m_p1;
	Param2 m_p2;
...
public:
	...
	CL_SignalQueue invokeQueue(Param1 p1, Param2 p2) {
		CL_SharedPtr<CL_SignalQueue_Impl> queue(new CL_SignalQueue_v2_Impl<Param1, Param2>(this, p1, p2));
