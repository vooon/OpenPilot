...
class CL_SlotCallback_v0 : public CL_SlotCallback
{
public:
...
/// (Internal ClanLib Class)
/// \xmlonly !group=Core/Signals! !header=core.h! !hide! \endxmlonly
class CL_SlotCallback_v0_static : public CL_SlotCallback_v0
{
public:
...
class CL_SignalQueue_v0_Impl : public CL_SignalQueue_Impl
{
public:
	CL_SignalQueue_v0_Impl(CL_Signal_v0* signal) : m_signal(signal) { }
	
	CL_Signal_v0* m_signal;
...
public:
	...
	CL_SignalQueue invokeQueue() {
		CL_SharedPtr<CL_SignalQueue_Impl> queue(new CL_SignalQueue_v0_Impl(this));
