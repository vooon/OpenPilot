...
template <class Param1, class Param2, class Param3, class Param4>
class CL_SignalQueue_v4_Impl : public CL_SignalQueue_Impl
{
public:
	CL_SignalQueue_v4_Impl(CL_Signal_v4<Param1, Param2, Param3, Param4>* signal,
						   Param1 p1, Param2 p2, Param3 p3, Param4 p4) : m_signal(signal), m_p1(p1), m_p2(p2), m_p3(p3), m_p4(p4) { }
	
	CL_Signal_v4<Param1, Param2, Param3, Param4>* m_signal;
	Param1 m_p1;
	Param2 m_p2;
	Param3 m_p3;
	Param4 m_p4;
...
public:
	...
	CL_SignalQueue invokeQueue(Param1 p1, Param2 p2, Param3 p3, Param4 p4) {
		CL_SharedPtr<CL_SignalQueue_Impl> queue(new CL_SignalQueue_v4_Impl<Param1, Param2, Param3, Param4>(this, p1, p2, p3, p4));
