...
template <class Param1>
class CL_SignalQueue_v1_Impl : public CL_SignalQueue_Impl
{
public:
	CL_SignalQueue_v1_Impl(CL_Signal_v1<Param1>* signal, Param1 p1) : m_signal(signal), m_p1(p1) { }
	
	CL_Signal_v1<Param1>* m_signal;
	Param1 m_p1;
...
public:
	...
	CL_SignalQueue invokeQueue(Param1 p1) {
		CL_SharedPtr<CL_SignalQueue_Impl> queue(new CL_SignalQueue_v1_Impl<Param1>(this, p1));
