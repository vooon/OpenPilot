...
class CL_Callback_Impl_5
{
public:
	virtual ~CL_Callback_Impl_5()
	{
	}
...
/// \xmlonly !group=Core/Signals! !header=core.h! !hide! \endxmlonly
template <typename RetVal, typename P1, typename P2, typename P3, typename P4, typename P5>
class CL_Callback_Impl_5_static : public CL_Callback_Impl_5<RetVal, P1, P2, P3, P4, P5>
{
public:
	CL_Callback_Impl_5_static(RetVal (*static_func)(P1, P2, P3, P4, P5))
...
class CL_Callback_Impl_5_static_user : public CL_Callback_Impl_5<RetVal, P1, P2, P3, P4, P5>
{
public:
	CL_Callback_Impl_5_static_user(
...
class CL_Callback_Impl_5_member : public CL_Callback_Impl_5<RetVal, P1, P2, P3, P4, P5>
{
public:
	CL_Callback_Impl_5_member(InstanceClass *instance,
...
class CL_Callback_Impl_5_member_user : public CL_Callback_Impl_5<RetVal, P1, P2, P3, P4, P5>
{
public:
	CL_Callback_Impl_5_member_user(InstanceClass *instance,
...
class CL_Callback_Impl_5_functor : public CL_Callback_Impl_5<RetVal, P1, P2, P3, P4, P5>
{
public:
	CL_Callback_Impl_5_functor(Functor functor)
	: functor(functor)
	{
	}
...
public:
	...
	: impl(new CL_Callback_Impl_5_static<RetVal, P1, P2, P3, P4, P5>(function))
	{
	}

	template<typename UserData>
	CL_Callback_5(RetVal (*function)(P1, P2, P3, P4, P5, UserData), const UserData &user_data)
	: impl(new CL_Callback_Impl_5_static_user<RetVal, P1, P2, P3, P4, P5, UserData>(function, user_data))
	{
	}

	template<class InstanceClass>
	CL_Callback_5(InstanceClass *instance, RetVal (InstanceClass::*function)(P1, P2, P3, P4, P5))
	: impl(new CL_Callback_Impl_5_member<RetVal, P1, P2, P3, P4, P5, InstanceClass>(instance, function))
	{
	}
	...
	: impl(new CL_Callback_Impl_5_member_user<RetVal, P1, P2, P3, P4, P5, InstanceClass, UserData>(instance, function, user_data))
	{
	}

	void set(RetVal (*function)(P1, P2, P3, P4, P5))
	{
		impl = CL_SharedPtr< CL_Callback_Impl_5<RetVal, P1, P2, P3, P4, P5> >(new CL_Callback_Impl_5_static<RetVal, P1, P2, P3, P4, P5>(function));
	}

	template<typename UserData>
	void set(RetVal (*function)(P1, P2, P3, P4, P5, UserData), const UserData &user_data)
	{
		impl = CL_SharedPtr< CL_Callback_Impl_5<RetVal, P1, P2, P3, P4, P5> >(new CL_Callback_Impl_5_static_user<RetVal, P1, P2, P3, P4, P5, UserData>(function, user_data));
	}

	template<class InstanceClass>
	void set(InstanceClass *instance, RetVal (InstanceClass::*function)(P1, P2, P3, P4, P5))
	{
		impl = CL_SharedPtr< CL_Callback_Impl_5<RetVal, P1, P2, P3, P4, P5> >(new CL_Callback_Impl_5_member<RetVal, P1, P2, P3, P4, P5, InstanceClass>(instance, function));
	}

	template<class InstanceClass, typename UserData>
	void set(InstanceClass *instance, RetVal (InstanceClass::*function)(P1, P2, P3, P4, P5, UserData), const UserData &user_data)
	{
		impl = CL_SharedPtr< CL_Callback_Impl_5<RetVal, P1, P2, P3, P4, P5> >(new CL_Callback_Impl_5_member_user<RetVal, P1, P2, P3, P4, P5, InstanceClass, UserData>(instance, function, user_data));
	}
...
private:
	CL_SharedPtr< CL_Callback_Impl_5<RetVal, P1, P2, P3, P4, P5> > impl;
};

/// \brief CL_Callback_5_functor
///
/// \xmlonly !group=Core/Signals! !header=core.h! \endxmlonly
template <typename RetVal, typename P1, typename P2, typename P3, typename P4, typename P5>
class CL_Callback_5_functor : public CL_Callback_5<RetVal, P1, P2, P3, P4, P5>
{
public:
	CL_Callback_5_functor()
	{
	}

	CL_Callback_5_functor(const CL_Callback_5_functor &copy)
	: CL_Callback_5<RetVal, P1, P2, P3, P4, P5>(copy)
	{
	}

	template<class Functor>
	CL_Callback_5_functor(Functor functor)
	: CL_Callback_5<RetVal, P1, P2, P3, P4, P5>(new CL_Callback_Impl_5_functor<RetVal, P1, P2, P3, P4, P5, Functor>(functor))
	{
	}
