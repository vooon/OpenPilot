...
const CString $(NAME)::NAME = CString("$(NAME)");
const CString $(NAME)::DESCRIPTION = CString("$(DESCRIPTION)");
const CString $(NAME)::CATEGORY = CString("$(CATEGORY)");
...
$(FIELDSINIT)
    // Initialize object
    initializeFields(fields, (opuint8*)&data, NUMBYTES);
    ...
    m_slotObjectUpdated = m_signal_objectUpdated.connect(this, &$(NAME)::emitNotifications);
}
...
void $(NAME)::emitNotifications(UAVObject*)
{
 ...
 */
UAVDataObject* $(NAME)::clone(opuint32 instID)
{
    $(NAME)* obj = new $(NAME)();
 ...
 */
$(NAME)* $(NAME)::GetInstance(UAVObjectManager* objMngr, opuint32 instID)
{
