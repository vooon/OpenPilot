...
int32_t $(NAME)Initialize(void)
{
  ...
  handle = UAVObj::Register($(NAMEUC)_OBJID, $(NAMEUC)_NAME, $(NAMEUC)_METANAME, 0,
...
void $(NAME)SetDefaults(UAVObjHandle obj, uint16_t instId)
{
  ...
  UAVObj::GetInstanceData(obj, instId, &data);
  memset(&data, 0, sizeof($(NAME)Data));
  $(INITFIELDS)
    UAVObj::SetInstanceData(obj, instId, &data);
  ...
  UAVObj::SetMetadata(obj, &metadata);
}
