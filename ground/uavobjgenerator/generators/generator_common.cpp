...
void replaceCommonTags(QString& out, ObjectInfo* info)
{
    ...
    out.replace(QString("$(ISSINGLEINSTYN)"), boolToYESNOString( info->isSingleInst ));
    ...
    out.replace(QString("$(ISSETTINGSYN)"), boolToYESNOString( info->isSettings ));
    ...
    out.replace(QString("$(FLIGHTTELEM_ACKEDYN)"), boolToYESNOString( info->flightTelemetryAcked ));
    ...
    out.replace(QString("$(GCSTELEM_ACKEDYN)"),  boolToYESNOString( info->gcsTelemetryAcked ));
    ...
    value = QString("%1").arg(info->fields.length());
    out.replace(QString("$(NUMFIELDS)"), value);
