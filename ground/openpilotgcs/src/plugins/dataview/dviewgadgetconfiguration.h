...
#ifndef DVIEWGADGETCONFIGURATION_H
#define DVIEWGADGETCONFIGURATION_H
...
class DViewGadgetConfiguration : public IUAVGadgetConfiguration
{
    Q_OBJECT
    public:
        explicit DViewGadgetConfiguration(QString classId, QSettings* qSettings = 0, QObject *parent = 0);
...
#endif // DVIEWGADGETCONFIGURATION_H
