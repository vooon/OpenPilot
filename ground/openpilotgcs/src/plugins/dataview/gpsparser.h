...
signals:
   void systemstats(double);
   void dop(double,double,double);
   void linkstatus(QString,double,double);

   void attitude(double,double,double);
   void airspeed(double);
   void altitude(double,double,double);
   void battery(double,double,double);
