...
#include "ui_dviewgadgetoptionspage.h"

#include <QFileDialog>
#include <QtAlgorithms>
#include <QStringList>

DViewGadgetOptionsPage::DViewGadgetOptionsPage(DViewGadgetConfiguration *config, QObject *parent) :
        IOptionsPage(parent),
        m_config(config)
{
...
QWidget *DViewGadgetOptionsPage::createPage(QWidget *parent)
{
 ...
 *
 */
void DViewGadgetOptionsPage::apply()
{

}

void DViewGadgetOptionsPage::finish()
{
    delete options_page;
}
