...
#ifndef MODELVIEWQT3DGADGET_H_
#define MODELVIEWQT3DGADGET_H_
...
class QWidget;
class QString;
class ModelViewQt3DGadgetWidget;
...
private:
    ModelViewQt3DGadgetWidget *m_widget;
};

#endif // MODELVIEWQT3DGADGET_H_
