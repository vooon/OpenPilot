...
public:
    ...
    virtual void setupTcpPorts(const QString& host, int inPort, int outPort)
    { Q_UNUSED(host) Q_UNUSED(inPort) Q_UNUSED(outPort)}
...
private slots:
    void onStart();
    void receiveUpdateUdp();
    void receiveUpdateTcp();
...
{
public:
    SimulatorCreator(QString id, QString descr) : classId(id), description(descr) {}
