 ...
 ******************************************************************************
 *
 * @file       generici2cconfiguration.cpp
...
#include "generici2cconfiguration.h"

GenericI2CConfiguration::GenericI2CConfiguration(QString classId, QSettings* qSettings, QObject *parent) :
...
IUAVGadgetConfiguration *GenericI2CConfiguration::clone()
{
    GenericI2CConfiguration *m = new GenericI2CConfiguration(this->classId());
...
//	m->settings = settings;
  ...
  *
  */
void GenericI2CConfiguration::saveConfig(QSettings* qSettings) const {
